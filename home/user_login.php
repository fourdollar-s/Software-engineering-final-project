				...
				<div class="input">
					<form method="post" action="">
						...
						<table border="0" width="70%" height="25%">
							...
							<td align="left"><input type=text name="account" style="width:200px;height:30px;font-size:18px" required="required"></td>
							</tr>
							<tr>
							<td align="center" width=300><font size="4">密碼</font></td>
							<td align="left"><input type=password name="password" style="width:200px;height:30px;font-size:18px" required="required"></td>
							</tr>
						</table>
						<p align="center">
						<input value="登入" name="sub" type="submit" style="font-size:18px;margin:40px;background-color: white;">
						<a href="passwd_forgot.php">忘記密碼?</a>
						</p>
					</form>
				</div>
			</div>
	...
	if (isset($_POST["sub"])) 
	{
		...
		if(($account != NULL) && ($password != NULL)){				
			...
			if (!$row) {
				...
				echo "<script> document.location.href='../RSS/user.php';</script>";
			}
