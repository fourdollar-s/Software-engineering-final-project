...
<html lang="zh-TW">
	...
	<body>
        ...
        if(isset($_POST['sub'])){
            ...
            if ($sql_qry->exec($sql)) {
                echo "<script> alert('刪除成功');window.location.href='s_del_acc.php';</script>";
            } 
            else{
                echo "<script> alert('刪除失敗');window.location.href='s_del_acc.php';</script>";
            }
