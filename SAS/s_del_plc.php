...
<html lang="zh-TW">
	...
	<body>
		...
		<!---->
		<div class="content">
        <div class=title>刪除場地</div>
        <div class="announce">
        <table border=1 width="100%">
            <tr>
                <td align=center>場地編號</td>
                <td align=center>類型</td>
                <td align=center>校內價錢</td>
                <td align=center>校外價錢</td>
                <td style="text-align: center;">資料刪除</td>
            </tr>
		<?php
            include("../connect.php");
        ...
        if (isset($_POST["sub"])) {
            ...
            if($sql_qry->exec($sql))
                echo "<script> alert('刪除成功');document.location.href='s_del_plc.php';</script>";
            else
                echo "<script> alert('刪除錯誤');document.location.href='s_del_plc.php';</script>";
        }
        ?>
		</div>
		</div>
